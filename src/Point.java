...
public class Point implements Comparable<Point> {
    ...
    public double slopeTo(Point that) {
        ...
        if (Double.compare(that.x - this.x, 0.0) == 0) {// vertical
    ...
    public Comparator<Point> slopeOrder() {
        /* YOUR CODE HERE */
        return new SlopeMergeComparator(this);
    }
    ...
    private class SlopeMergeComparator implements Comparator<Point> {

        private Point now;

        public SlopeMergeComparator(Point now) {
            super();
            this.now = now;
        }
        ...
        public int compare(Point o1, Point o2) {
            ...
            double slope1 = now.slopeTo(o1);
            double slope2 = now.slopeTo(o2);
            if (slope1 < slope2) {
                return -1;
