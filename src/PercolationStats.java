...
public class PercolationStats {
    ...
    public double confidenceLo() {
        ...
        double temp = 1.96 * stddev / java.lang.StrictMath.pow(threshold.length, 1.0 / 2);
        return mean - temp;
    }
    ...
    public static void main(String[] args) {
        ...
        StdOut.println("95% confidence interval = " + percStates.confidenceLo() + ", " + percStates.confidenceHi());
    }
}
